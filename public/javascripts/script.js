...
// Have removed the localhost:3000 because by default socket io connects to the socket
// sever at the same address/ host. because back end and front end is are hosted to the
// localhost socket io knows what to do without us having to tell it explicitly
// const socket = io();
